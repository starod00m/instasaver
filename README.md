...
Telegram-бот для автоматического скачивания видео из Instagram Reels и TikTok в группах и каналах.

## Описание

InstaSaver - это простой Telegram-бот, который отслеживает сообщения в группах и каналах, автоматически распознает ссылки на Instagram Reels и TikTok, и скачивает видео с помощью yt-dlp. Бот отправляет скачанное видео ответом (reply) на исходное сообщение.
